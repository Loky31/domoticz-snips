...
def subscribe_intent_callback(hermes, intentMessage):
    ...
    hermes.publish_continue_session(intentMessage.session_id, "Très bien",["Loky31:IntentLumiere","Loky31:IntentOrdreDivers"])
...
def action_wrapperOrdreDirect(hermes, intentMessage, conf):
    ...
    if MyAction[0] : 
        ...
        print("pas d action")
        hermes.publish_end_session(intentMessage.session_id, "je suis confue, je ne peux pas m executer ")
...
def action_wrapperOrdre(hermes, intentMessage, conf):
    ...
    if myAction and len(intentSwitchActionList)>0: 
        ...
        hermes.publish_continue_session(intentMessage.session_id,"pouvez vous répéter je n'ai pas compris",["Loky31:IntentLumiere","Loky31:IntentOrdreDivers"])
...
if __name__ == "__main__":
    ...
    with Hermes(mqtt_options=mqtt_opts) as h:
        h.subscribe_intent("Loky31:IntentLumiere", subscribe_intent_callback)\
        .subscribe_intent("Loky31:IntentOrdreDivers", subscribe_intent_callback)\
        .start()
